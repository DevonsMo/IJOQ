                ...
                for section_y in range(cal_confirmed_section_number):
                    ...
                    for x in range(cal_confirmed_pixel_number):
                        for y in range(cal_confirmed_pixel_number):
                            pixel_x = round(
                                section_width * (section_x + ((x + 0.5) / cal_confirmed_pixel_number)))
                            pixel_y = round(
                                section_height * (section_y + ((y + 0.5) / cal_confirmed_pixel_number)))
...
def gui_set(x, y, min_x, min_y, title, icon_name, image_formats, version, directory):
    """
    ...
    global valid_image_types, current_version
    valid_image_types = image_formats
    ...
    global cal_cell_number_x, cal_cell_number_y, cal_channel_selection, cal_image_compression, cal_blur_radius, \
        cal_section_number, cal_pixel_number, cal_noise_filter, cal_line_number, cal_results_blur_radius, \
        cal_results_noise_filter
    ...
    global cal_settings_options_tabs
    ...
    global cal_settings_confirm_button
    ...
    # Add a progress bar
    global cal_calibration_progress_bar
    ...
    global cal_calibration_textbox
    ...
    # Add previous and confirm button
    global cal_calibration_previous_button, cal_calibration_confirm_button
    ...
    # Arrows for picture
    global cal_results_picture_left_arrow_button, cal_results_picture_right_arrow_button
    ...
    # Textbox for Picture
    global cal_results_picture_label
    ...
    global cal_results_settings_value_label
    ...
    global cal_results_settings_blur_slider, cal_results_settings_blur_spinbox
    ...
    cal_results_settings_blur_slider = ttk.Scale(
        ...
        command=lambda e: cal_results_blur_radius.set(
            int(round(float(cal_results_blur_radius.get())))))
    ...
    cal_results_settings_blur_spinbox = ttk.Spinbox(
        ...
        command=lambda: cal_update_results(cal_results_blur_radius.get(), cal_confirmed_noise_filter),
        validate="key", validatecommand=vcmd_int)
    ...
    global cal_results_settings_noise_slider, cal_results_settings_noise_spinbox
    ...
    # Parameter value label for the settings
    global anl_settings_value_label
    ...
    # Add previous and confirm button
    global anl_settings_confirm_button
    ...
    # Add a progress bar
    global anl_analysis_progress_bar
    ...
    # Add previous and confirm button
    global anl_analysis_previous_button, anl_analysis_confirm_button
    ...
    # Arrows for picture
    global anl_results_picture_left_arrow_button, anl_results_picture_right_arrow_button
    ...
    # Textbox for Picture
    global anl_results_picture_label
